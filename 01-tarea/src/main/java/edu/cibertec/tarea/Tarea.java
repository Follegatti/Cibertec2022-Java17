...
public class Tarea {
    public static void main(String[] args) {
     ...
     /* Creacion de una factura de Venta:
        La cualñ contara con datos del vendedor como datos del cliente
        La factura debe imcluir IGV , RUC natural (es la concatenacion
        al inicio 20+dni+5) ademas del total
